...
def run_single(NUMRUN, NUMHYP, NUMDRAWS, mu_gap,lbd_scale, pi, alpha0, mod_choice, FDR, eps, sensitivity,shift, sigma = 1, verbose = False, TimeString = False, rndseed = 1, startfac = 0.1):
    ...
    dir_name = './dat'
    filename = 'Lbd%.2f_Si%.1f_FDR%d_NH%d_ND%d_MOD%d_EPS%.1f_SE%.1f_SHT%.1f_PM%.2f_NR%d_%s' % (lbd_scale, sigma, FDR, NUMHYP, NUMDRAWS, mod_choice, eps, sensitivity,shift, pi, NUMRUN, time_str)
